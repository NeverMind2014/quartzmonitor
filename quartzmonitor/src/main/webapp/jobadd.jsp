...
<body>
	...
	<div id="content" class="container_16 clearfix">
		...
		<div class="grid_5">
			<p>
				<label for="title">job名称:<small>*</small></label> <input type="text"
					name="title" />
			</p>
		</div>
		...
		<div class="grid_5">
			<p>
				<label for="title">所属组: <small>*</small></label> <input type="text"
					name="title" />
			</p>
		...
		<div class="grid_6">
			<p>
				<label for="title">所属Schedule<small>*</small></label> <select>
					<option>Draft</option>
		...
		<div class="grid_16">
			<p>
				<label>job类型<small>*</small></label> <input type="text" name="title" />
			</p>
		</div>
