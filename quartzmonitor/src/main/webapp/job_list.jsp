...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="delete" href="<%=request.getContextPath()%>/job/delete.action?jobuuid={sid_user}" target="ajaxTodo" title="确定要删除吗？" warn="请选择一个用户" rel="triggerList" mask="true"><span>删除</span></a></li>
            <li><a class="edit" href="<%=request.getContextPath()%>/job/edit.action?jobuuid={sid_user}" target="dialog" warn="请选择一记录"><span>修改</span></a></li>
