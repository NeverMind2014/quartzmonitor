...
<div class="pageContent">
	...
	<table class="list" width="98%" targetType="navTab" asc="asc" desc="desc" layoutH="116">
		<thead>
			<tr>
				<th width="100" orderField="num" class="desc" align="middle">连接名称</th>
		...
		<s:iterator value="quartzMap" id="map">
			<tr target="sid_user" rel="<s:property value="value.configId"/>">
				...
				<s:else>
				<a class="delete" href="<%=request.getContextPath()%>/init/config?uuid=${value.configId}"  target="ajaxTodo" fresh="true">设为默认
				</a>
				</s:else>
				</td>
			</tr>
