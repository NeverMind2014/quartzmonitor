...
public class Job {
	...
	private String uuid;
	private String quartzConfigId;//configId
	private String remoteSchedulerInstanceId;//remote scheduler Mbean instanceId
    ...
    public void setQuartzConfigId(String quartzConfigId) {
        this.quartzConfigId = quartzConfigId;
    }
	...
	public void setJobDataMapJson(String json) {
	...
	public String toString() {
		...
		sb.append("Job");
		sb.append("{quartzConfigId='").append(quartzConfigId).append('\'');
		sb.append(", remoteSchedulerInstanceId='").append(remoteSchedulerInstanceId).append('\'');
