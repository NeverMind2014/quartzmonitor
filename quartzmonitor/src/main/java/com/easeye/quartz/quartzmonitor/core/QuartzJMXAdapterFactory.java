...
public class QuartzJMXAdapterFactory {
	/**
	 * Currently creates the v2.0.0 adapter. In the future, we will need to have an adapter map that returns the correct adapter object to use depending on version.
	 * 
	 * @param objectName
	 * @param connection
	 * @return
